...
namespace Autopark.Data
{
    public class ApplicationDbContext : IdentityDbContext<AppUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            Vehicle chery8 = new() { Id = 1, BrandId = 1, HorsePower = 5000, Mileage = 2000, Name = "Chery Tiggo Pro Max 8", Price = 3_120_000, Year = 2023, ZeroToHundred = 8.5f, EnterpriseId = 1, DriverId = 1 };
            Vehicle chery7 = new() { Id = 2, BrandId = 1, HorsePower = 5500, Mileage = 4000, Name = "Chery Tiggo Pro Max 7", Price = 2_055_000, Year = 2022, ZeroToHundred = 9.8f, EnterpriseId = 1 };
            Vehicle chery6 = new() { Id = 3, BrandId = 1, HorsePower = 5000, Mileage = 10_000, Name = "Chery Tiggo Pro Max 6", Price = 3_120_000, Year = 2021, ZeroToHundred = 8.5f, EnterpriseId = 2, DriverId = 2 };
            ...
            Vehicle ferrariVehicle = new() { Id = 5, BrandId = 3, HorsePower = 10_000, Mileage = 0, Name = "FERRARI F430", Price = 130_120_000, Year = 2020, ZeroToHundred = 1.8f, EnterpriseId = 3, DriverId = 3 };
